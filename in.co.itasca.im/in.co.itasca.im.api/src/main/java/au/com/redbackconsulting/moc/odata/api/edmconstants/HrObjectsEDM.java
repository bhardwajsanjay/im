...
public class HrObjectsEDM  extends BaseEDM{
	public HrObjectsEDM(String namespace   ) {
		super(namespace,HrObjectsEDM.ENTITY_TYPE_NAME, ENTITY_SET_NAME);
		// TODO Auto-generated constructor stub
	}
	public static String ENTITY_TYPE_NAME="HrObjects";
	public static String ENTITY_SET_NAME="HrObjectsSet";
